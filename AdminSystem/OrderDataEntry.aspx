...
<body style="height: 351px">
    <form id="form1" runat="server">
        <asp:Label ID="lblStockID" runat="server" style="z-index: 1; left: 593px; top: 56px; position: absolute" Text="StockID"></asp:Label>
        ...
        <asp:TextBox ID="txtOrderID" runat="server" Style="z-index: 1; top: 56px; position: absolute; left: 660px" OnTextChanged="txtOrderID_TextChanged"></asp:TextBox>
        <asp:TextBox ID="txtCustomerID" runat="server" style="z-index: 1; left: 660px; top: 85px; position: absolute"></asp:TextBox>
        <asp:TextBox ID="txtOrderDate" runat="server" style="z-index: 1; left: 660px; top: 150px; position: absolute"></asp:TextBox>
        ...
        <asp:TextBox ID="txtStockID" runat="server" style="z-index: 1; left: 660px; top: 189px; position: absolute"></asp:TextBox>
        <asp:Label ID="lblError" runat="server" style="z-index: 1; left: 512px; top: 290px; position: absolute"></asp:Label>
    </form>
        <asp:Button ID="btnFind" runat="server" Style="z-index: 1; left: 808px; top: 52px; position: absolute" Text="Find" OnClick="btnFind_Click1" />
</body>
